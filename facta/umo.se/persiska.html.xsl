...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Om-UMO/persiska'"/>
    ...
    <xsl:variable name="mainlang" select="'fas'"/>
	...
	<parallel_text xml:lang="eng" location="about-umo.html"/>
	<parallel_text xml:lang="fin" location="umosta.html"/>
	...
	<parallel_text xml:lang="rus" location="o-umo.html"/>
	<parallel_text xml:lang="spa" location="sobre-umo.html"/>
	<parallel_text xml:lang="swe" location="om-umo.html"/>
	<parallel_text xml:lang="tur" location="umo-hakknda.html"/></xsl:variable>
